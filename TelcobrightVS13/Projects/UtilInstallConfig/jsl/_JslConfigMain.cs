            ...
            this.Tbc.CdrSetting = new CdrSetting
            {
                ...
                ExceptionalCdrPreProcessingData = new Dictionary<string, Dictionary<string, string>>()
                {
                    { "DateChangerForCdr",new Dictionary<string, string>()
                        {
                            { "random","true"},
                            { "changeDateStart","2020-12-02 15:00:00" },
                            { "changeDateEnd","2020-12-02 17:00:00" },
                            { "jobNames",$@"ICX20201202115062418_0001.DAT,
                                            ICX20201202115062418_0002.DAT,
                                            ICX20201202115062418_0003.DAT,"
                            }
                        }
                    },
